...
<link rel="stylesheet" href="__CSS__/show_tz.css">
<script src="__JS__/show_tz.js"></script> 
...
<input type="hidden" id="tz_id_hide" value="<?php echo ($post["post_id"]); ?>">
<div id="show_tz">
  <!--帖子回复-->
   <table class="table table-striped table-bordered table-condensed">
     <tr><td rowspan="3" width="100px;" style="color:#009;"><?php echo ($fb_user["username"]); ?> <br></td><td style="
     color:#F60;">发表时间 ： <?php echo ($post["datetime"]); ?></td></tr>
     <tr><td style="height:auto;padding:10px;"><?php echo ($post["content"]); ?></td></tr>
     <tr><td>
        <ul id="tz_hd_ul">
          <li>回复(<?php echo count($post_replays); ?>)</li>
          <li>|</li>
          <li>点击(<?php echo ($post["clicks"]); ?>)</li>
          <li>|</li>
          <li><a id="tz_zan">赞(<span id="praise_count"><?php echo ($post["praise_number"]); ?></span>)</a></li>
          <li><span id="post_praise_warning"></span></li>
          <li>|</li>
          <li>举报</li>
        </ul>
   </table>
...
<!--回复-->
<!--<?php var_dump($replay_user_arr); ?>-->
  <?php $n=0; ?>
 <?php if(is_array($post_replays)): foreach($post_replays as $key=>$vo): ?><table class="table table-striped table-bordered table-condensed">
     <tr><td rowspan="3" width="100px;" style="color:#009;"><?php echo ($replay_user_arr[$n++]["username"]); ?></td><td style="color:#F60;">回复时间 : <?php echo ($vo["datetime"]); ?></td></tr>
     <tr><td style="height:auto;padding:10px;"><?php echo ($vo["content"]); ?></td></tr>
     <tr><td><span style="margin-left:70%;">举报</span></td></tr>
   </table><?php endforeach; endif; ?>


<!--回复-->
   <table class="table table-striped table-bordered table-condensed">
     <tr><td rowspan="2" width="100px;"></td>
        <td>
         <textarea rows="30" cols="50" id="tz_replay_content" name="tz_replay_content" ></textarea>
        </td>
     </tr>
     <tr>
     <td style="height:auto;padding:10px;"><button id="sub_tz_replay" class="btn btn-primary">提交回复</button><span id="tz_replay_warning" class="control-group"></span></td></tr>
  </table>
