...
<link rel="stylesheet" href="__CSS__/show_gl.css">

<script type="text/javascript" src="__JS__/show_gl.js"></script>
...
<input type="hidden" id="gl_id_hide" value="<?php echo ($cheat["cheats_id"]); ?>">   
<div id="show_gl">
   <table class="table table-striped table-bordered table-condensed">
     <tr><td rowspan="3" width="100px;"><?php echo ($cheat["user"]["username"]); ?></td><td>发表时间 : <?php echo ($cheat["datetime"]); ?></td></tr>
     <tr><td style="height:auto;padding:10px;"><?php echo ($cheat["content"]); ?></td></tr>
     <tr><td>
        <ul id="gl_hd_ul">
          <li>回复(<?php echo count($cheat_replays); ?>)</li>
          <li>|</li>
          <li>点击(<?php echo ($cheat["clicks"]); ?>)</li>
          <li>|</li>
	  <li><a id="gl_zan">赞(<span id="praise_count"><?php echo ($cheat["praise"]); ?></span>)</a></li>
          <li><span id="praise_warning"></span></li>
          <li>|</li>
          <li>举报</li>
        </ul>
       </td></tr>
...
<!--<?php var_dump($replay_user_arr); ?>-->
  <?php $n=0; ?>
  <?php if(is_array($cheat_replays)): foreach($cheat_replays as $key=>$vo): ?><table class="table table-striped table-bordered table-condensed">
     <tr><td rowspan="3" width="100px;"><?php echo ($replay_user_arr[$n++]["username"]); ?></td><td>回复时间 : <?php echo ($vo["datetime"]); ?></td></tr>
...
<!--回复-->
   <table class="table table-striped table-bordered table-condensed">
     <tr><td rowspan="2" width="100px;"></td>
        <td>
         <textarea rows="30" cols="50" id="gl_replay_content" name="gl_replay_content" ></textarea>
        </td>
     </tr>
     <tr>
     <td style="height:auto;padding:10px;"><button id="sub_gl_replay" class="btn btn-primary">提交回复</button><span id="gl_replay_warning" class="control-group"></span></td></tr>
  </table>
