...
<link rel="stylesheet" href="__CSS__/show_gg.css">
  ...
  <div id="show_gg_main">
    <div id="theme"><h2><?php echo ($board["theme"]); ?></h2></div>
    <div id="content"><?php echo ($board["info"]); ?>
    
    <div id="datetime"><?php echo ($board["time"]); ?></div>
    </div>
