 ...
 $n=0; $m=0; echo count($results_arr); ?></span>
  ...
  <div id="search_result_main">
    <span id="search_result_count">
	   <!-- <?php  echo "<pre>"; print_r($demo); echo "</pre>"; ?>-->
    </span> 
   <div class="row">
       <div class="span8">
	       <?php
	...
	<div id="result_main">      
        <?php if(is_array($results_arr)): foreach($results_arr as $key=>$result): ?><div class='search_result_contain'>
             ...
             <div class="search_result_header">
              <h2>
               <a class="title" href="__APP__/Show/show_tz?post_id=<?php echo ($result["0"]); ?>"><?php echo ($result["1"]); ?></a>
                <a class="more" style="background:url(__IMG__/nav-icons.png) no-repeat 0 -370px;" title="阅读全文" href="__APP__/Show/show_tz?post_id=<?php echo ($result["0"]); ?>"></a>
              </h2>
             </div>
	     ...
	     <span class="search_result_comment" style="background:url(__IMG__/nav-icons.png) no-repeat 0 -200px"><?php echo $results_replays_count[$m++] ?></span>
            ...
            <div class="search_result_content">
             <?php echo ($result["2"]); echo '.......' ?>
            </div>
         </div><?php endforeach; endif; ?>
        </div>
	<div class="well" id="add_more_posts_search_result_div"><span id="result_page_id">1</span><a id="add_more_posts_search_resultt">点击加载更多</a><span id="search_content"><?php echo ($search_content); ?></span></div>
	 <?php
 }else{ ?>
